    ...
    categories: [
      {
        ...
        products: [
          { icon:'💎', name:'400 Robux',    desc:'Carga rápida vía GamePass. Entrega en minutos.',            price:'$50',  avail:true },
          ...
          { icon:'💎', name:'4,500 Robux',  desc:'Para jugadores serios. Máxima relación precio-cantidad.',  price:'$440', avail:true },
      ...
      },
      {
        ...
        products: [
          ...
          { icon:'⭐', name:'Cuenta Premium',  desc:'Roblox Premium activo + varios items y robux incluidos.',    price:'$250', avail:true },
      ...
      },
      {
        ...
        products: [
          { icon:'🐉', name:'Dragon Neon',        desc:'Mascota legendaria en versión Neon.',                       price:'$120', avail:true },
          { icon:'🦄', name:'Unicornio Mega Neon', desc:'Versión Mega Neon del clásico. Brilla en 4 colores.',      price:'$200', avail:true },
          { icon:'🐺', name:'Pack x3 Legendarios', desc:'Tres mascotas legendarias de temporadas pasadas.',         price:'$180', avail:true },
        ]
      },
      {
        id: 'mm2', label: '🔪 Murder Mystery 2',
        products: [
      ...
      {
        id: 'ps99', label: '🐶 Pet Simulator 99',
        products: [
          { icon:'🐶', name:'Huge Cat (Exclusivo)', desc:'Huge pet de rareza máxima. Boost de monedas x10.',       price:'$300', avail:true },
          { icon:'💰', name:'1B Diamantes',          desc:'Diamantes para canjear en el juego. Entrega inmediata.', price:'$70',  avail:true },
          { icon:'🌟', name:'Pack Starter PS99',     desc:'3 mascotas raras + 500M monedas para empezar fuerte.',  price:'$130', avail:true },
        ]
      },
    ]
  },
    ...
    categories: [
      {
        id: 'cuentas', label: '👤 Cuentas',
        products: [
          { icon:'🛡️', name:'Cuenta OG Tier 100', desc:'Black Knight incluida. Temporadas 1-3. Muy codiciada.',    price:'$650', avail:true },
          { icon:'💀', name:'Cuenta Skull Trooper', desc:'Skull Trooper original + 20 skins adicionales.',          price:'$450', avail:true },
          { icon:'🎮', name:'Cuenta Básica 10+',    desc:'10+ skins, nivel 50+. Perfecta para empezar.',           price:'$180', avail:true },
        ]
      },
      {
        ...
        products: [
          ...
          { icon:'💙', name:'5,000 V-Bucks',  desc:'Para skins grandes y cofres de colecciones.',                price:'$580', avail:true },
        ]
      },
      {
        id: 'skins', label: '🎭 Skins Raras',
        products: [
    ...
    categories: [
      {
        ...
        products: [
          ...
          { icon:'💎', name:'2,000 Diamonds', desc:'El pack grande. Ideal para eventos especiales.',            price:'$480', avail:true },
    ...
    categories: [
      {
        ...
        products: [
          { icon:'☕', name:'Java Edition',          desc:'Cuenta original Java. Versión más reciente, acceso completo.', price:'$220', avail:true },
      ...
      },
      {
        ...
        products: [
          ...
          { icon:'🎮', name:'Java + Bedrock Bundle', desc:'Las dos ediciones en una cuenta. La mejor opción.',           price:'$380', avail:true },
        ]
      },
    ]
  },
    ...
    categories: [
      {
        ...
        products: [
          ...
          { icon:'🌟', name:'Cuenta Smurf',     desc:'Nueva desbloqueada, lista para rankear desde cero.',        price:'$140', avail:true },
        ]
      },
      {
        id: 'vp', label: '💜 VP',
